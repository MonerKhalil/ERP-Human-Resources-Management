            ...
            <div class="ViewUsers">
                <div class="ViewUsers__Breadcrumb">
                    @include('System.Components.breadcrumb' , [
                        'mainTitle' => __("ViewAttendaceInfoAdmin") ,
                        'paths' => [['Home' , '#'] , ['Page']] ,
                        'summery' => __("TitleViewAttendaceInfoAdmin")
                    ])
                </div>
                                                        ...
                                                        <div class="Table__ContentTable">
                                                            <table class="Table__Table">
                                                                <tr class="Item HeaderList">
                                                                    ...
                                                                    <th class="Item__Col"><span>@lang("employeeName")</span></th>
                                                                    <th class="Item__Col"><span>@lang("DepartmentName")</span></th>
                                                                ...
                                                                @foreach($data as $ItemRow)
                                                                    <tr class="Item DataItem">
                                                                        ...
                                                                        <td class="Item__Col">
                                                                            {{$ItemRow->employee["first_name"]." ".$ItemRow->employee["last_name"]}}
                                                                        </td>
                                                                        <td class="Item__Col">
                                                                            {{ $sections[$ItemRow->employee["section_id"]] ?? "-" }}
                                                                        </td>
                                                                        <td class="Item__Col">
    ...
    @if($IsHavePermissionAttendanceRead)
        @php
            ...
            foreach ($sections as $Index=>$Section) {
                array_push($SectionTypes , [ "Label" => $Section , "Value" => $Index ]) ;
            }
        @endphp
        @include("System.Components.searchForm" , [
            ...
            'FilterForm' => [
                    ...
                    ['Type' => 'select' , 'Info' =>
                        ['Name' => "filter[section]" , 'Placeholder' => __("DepartmentName") ,
