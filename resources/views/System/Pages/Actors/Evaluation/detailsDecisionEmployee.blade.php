<?php
    $MyAccount = auth()->user() ;
    $IsHavePermissionEvaluationDecisionEdit = $MyAccount->can("update_decisions") || $MyAccount->can("all_decisions") ;
    $IsHavePermissionEvaluationDecisionRead = $MyAccount->can("read_decisions") || $MyAccount->can("all_decisions") ;
    $IsHavePermissionEvaluationDecisionExport = $MyAccount->can("export_decisions") || $MyAccount->can("all_decisions") ;
    $IsHavePermissionEvaluationDecisionDelete = $MyAccount->can("delete_decisions") || $MyAccount->can("all_decisions") ;
?>
                        ...
                        <div class="Col">
                            <div class="Card">
                                <div class="Card__Inner">
                                    @if($IsHavePermissionEvaluationDecisionRead)
                                    ...
                                    @endif
                                    @if($IsHavePermissionEvaluationDecisionExport || $IsHavePermissionEvaluationDecisionEdit
                                        || $IsHavePermissionEvaluationDecisionDelete)
                                        <div class="ListData">
                                                <div class="ListData__Head">
                                                    <h4 class="ListData__Title">
                                                ...
                                                <div class="ListData__Content">
                                                    <div class="Card__Inner px0">
                                                        @if($IsHavePermissionEvaluationDecisionExport)
                                                            <a href="{{route("system.decisions.print.pdf" , $decision["id"])}}"
                                                               class="Button Button--Primary">
                                                                @lang("decisionPrint")
                                                            </a>
                                                        @endif
                                                        @if($IsHavePermissionEvaluationDecisionEdit)
                                                            <a href="{{route("system.decisions.edit" , $decision["id"])}}"
                                                               class="Button Button--Primary">
                                                                @lang("decisionEdit")
                                                            </a>
                                                        @endif
                                                        @if($IsHavePermissionEvaluationDecisionDelete)
                                                            <form class="Form"
